...
import * as DefaultMapStories from './stories/BasicUsage/DefaultMap/DefaultMap.stories';

import { code } from './stories/BasicUsage/DefaultMap/code';
...
{/* show default map */}
<Canvas of={DefaultMapStories.Example} sourceState="none" />
